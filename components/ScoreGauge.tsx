  ...
  return (
    ...
    >
        <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
            <div className={`mb-5 px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border border-current ${tier.bg} ${tier.text} flex items-center gap-1.5`}>
                {tier.icon}
                {tier.risk}
            </div>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                    ...
                    >
                        <div className="flex items-baseline justify-center relative left-1">
                            <span className="text-5xl font-bold text-slate-800 dark:text-slate-100 tabular-nums tracking-tight">
                                <Counter value={percentage} />
                            </span>
                            <span className="text-sm font-medium text-slate-400 dark:text-slate-500 ml-0.5">%</span>
                        </div>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="text-center px-2 relative z-10">
                ...
                <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-snug max-w-[200px] mx-auto">
                    {description}
                </p>
            </div>
        </div>
