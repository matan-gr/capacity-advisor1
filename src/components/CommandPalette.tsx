      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-[20vh] px-4">
          ...
          <motion.div 
            ...
            className="w-full max-w-xl bg-white dark:bg-slate-900 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden relative flex flex-col max-h-[60vh]"
          >
            {/* Search Input */}
                  ...
                  >
                    ...
                    {cmd.shortcut && (
                      <span className={`text-[10px] font-mono px-1.5 py-0.5 rounded border ${
                          index === selectedIndex
                            ? 'border-indigo-200 dark:border-indigo-800 bg-indigo-100/50 dark:bg-indigo-900/50 text-indigo-600 dark:text-indigo-400'
            ...
            {/* Footer */}
            <div className="px-4 py-2 bg-slate-50 dark:bg-slate-950/50 border-t border-slate-100 dark:border-slate-800 flex justify-between items-center text-[10px] text-slate-400">
